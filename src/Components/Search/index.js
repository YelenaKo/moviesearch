    ...
    render() { 
        return ( 
            <div className = "search-container">
                <form className = "search-form" onSubmit = { this.props.submitHandler }>
                ...
                <div className = "search-error-message" style = {{background:this.props.messageStyle}}>{this.props.errorMessage}</div>
            </div>
        );
    }
}
